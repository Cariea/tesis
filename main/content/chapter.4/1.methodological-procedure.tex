...
\usubsubsection{Evaluacion  del LSTM Autoencoder Optimizado}
      ...
      % \begin{figure}[ht!]
      %       \centering
      %       \includegraphics[width=0.85\textwidth]{LSTM_Optimized/roc_optimized.pdf}
      %       \caption{Curva ROC y AUC del LSTM Autoencoder Optimizado}
      %       \label{fig:roc_lstm_optimized}
      % \end{figure}

      % \begin{figure}[ht!]
      %       \centering
      %       \includegraphics[width=0.85\textwidth]{LSTM_Optimized/anomalias_optimized.pdf}
      %       \caption{Gráficas de MSE por secuencia para el LSTM Autoencoder Optimizado.}
      ...
      \begin{itemize}
            \item  Exactitud (Accuracy):
                  ...
                  \end{align}
                  \myequations{Accuracy para LSTM Autoencoder Optimizado}
            \item Tasa de error (Error Rate):
                  ...
                  \end{align}
                  \myequations{Tasa de Error para LSTM Autoencoder Optimizado}
            \item Sensibilidad (Recall):
                  ...
                  \end{align}
                  \myequations{Recall para LSTM Autoencoder Optimizado}
            \item Precisión (Precision): 
                  ...
                  \end{align}
                  \myequations{Precision para LSTM Autoencoder Optimizado}
            \item Especificidad (Specificity): 
                  ...
                  \end{align}
                  \myequations{Specificity para LSTM Autoencoder Optimizado}
            \item F1 Score:  
