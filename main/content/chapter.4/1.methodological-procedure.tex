...
\begin{itemize}
      ...
      \item Sensibilidad (Recall o Verdaderos Positivos): proporción de eventos de anómalos correctamente detectados.
...
\begin{itemize}
      ...
      \item Métricas de Rendimiento
            ...
            \begin{align}
                  F1_{score} = 2 \cdot \frac{Precision * Recall}{Precision+Recall} = 2 \cdot \frac{(0.5707 * 0.2638)}{(0.5707 + 0.2638)}\approx 0.361
                  \label{eq:f1_if}
            \end{align}
...
\begin{figure}[ht!]
      \centering
      \includegraphics[width=0.25\textwidth]{Arquitectura/Arquitectura3.png}
