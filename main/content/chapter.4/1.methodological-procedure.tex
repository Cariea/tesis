...
\begin{table}[ht!]
      ...
      \begin{tabular}{ |p{1cm}|p{5cm}|p{5cm}|p{3cm}| }
            \hline
            \textbf{ID} & \textbf{Descripción}                                                                 & \textbf{Criterio de Aceptación}                                                                 & \textbf{Resultado} \\
            \hline
            R1          & El sistema debe monitorear continuamente el entorno acústico.                        & El sistema debe estar activo y registrando datos en todo momento.                             & Cumple             \\
            \hline
            R2          & El sistema debe detectar eventos acústicos relevantes.                               & El sistema debe identificar y clasificar eventos acústicos específicos (e.g., gritos, caídas). & Cumple             \\
            \hline
            R3          & El sistema debe diferenciar entre eventos normales y anómalos.                       & El sistema debe clasificar correctamente al menos el 80\% de los eventos como normales o anómalos. & Cumple             \\
            \hline
            R4          & El sistema debe generar alertas en tiempo real ante la detección de anomalías.       & El sistema debe enviar una alerta dentro de los 5 segundos posteriores a la detección de una anomalía. & Cumple             \\
            \hline
            R5          & El sistema debe ser capaz de operar en un entorno doméstico típico.                  & El sistema debe funcionar correctamente en un entorno con ruido ambiental común (e.g., televisión, conversaciones). & Cumple             \\
            \hline
            R6          & El sistema debe ser fácil de instalar y configurar.                                  & La instalación y configuración del sistema no deben tomar más de 30 minutos.                   & Cumple             \\
            \hline
            R7          & El sistema debe ser energéticamente eficiente para uso continuo.                     & El consumo energético del sistema no debe exceder los 5W en operación continua.                & Cumple             \\
            \hline
      \end{tabular}
      \caption{Requerimientos del Sistema de Monitoreo Acústico}
      \label{tab:otra}
\end{table}