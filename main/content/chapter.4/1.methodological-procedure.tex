...
\begin{itemize}
      \item  Exactitud (Accuracy): proporción de predicciones correctas respecto al total de casos evaluados.
            ...
            \begin{align}
                  ...
                  \label{eq:accuracy}
            \end{align}
            \myequations{Fórmula de Accuracy para LSTM Autoencoder}
      ...
      \item Tasa de error: proporción de predicciones incorrectas respecto al total.
            ...
            \begin{align}
                  ...
                  \label{eq:error}
            \end{align}
            \myequations{Fórmula de Tasa de Error para LSTM Autoencoder}
      ...
      \item Sensibilidad (Recall o Verdaderos Positivos): proporción de eventos de anomalos correctamente detectados.
            ...
            \begin{align}
                  ...
                  \label{eq:recall}
            \end{align}
            \myequations{Fórmula de Recall para LSTM Autoencoder}
      ...
      \item Precisión: La proporción de casos realmente positivos entre todos los casos que el modelo predijo como positivos.
            ...
            \begin{align}
                  ...
                  \label{eq:precision}
            \end{align}
            \myequations{Fórmula de Precision para LSTM Autoencoder}
      ...
      \item Especificidad: proporción de eventos no críticos correctamente descartados.
            ...
            \end{align}
            \myequations{Fórmula de Specificity para LSTM Autoencoder}
      ...
      \item F1 Score: media armónica entre la precisión y la sensibilidad, útil cuando es importante equilibrar ambas.
            ...
            \begin{align}
                  ...
                  \label{eq:f1score}
            \end{align}
            \myequations{Fórmula de F1 Score para LSTM Autoencoder}
...
\begin{itemize}
      ...
      \item Métricas de Rendimiento
            ...
            \end{align}
            \myequations{Fórmula de Accuracy para Isolation Forest}
            ...
            \begin{align}
                  ...
                  \label{eq:error_if}
            \end{align}
            \myequations{Fórmula de Tasa de Error para Isolation Forest}

            \begin{align}
                  Recall = \frac{2877}{2877+8031}\approx 0.2638 \notag \\
                  \label{eq:recall_if}
            \end{align}
            \myequations{Fórmula de Recall para Isolation Forest}

            \begin{align}
                  Precision = \frac{2877}{2877+2164}\approx 0.5707 \notag \\
                  \label{eq:precision_if}
            \end{align}
            \myequations{Fórmula de Precision para Isolation Forest}

            \begin{align}
                  Specificity = \frac{87737}{87737+2164}\approx 0.9759 \notag \\
                  \label{eq:specificity_if}
            \end{align}
            \myequations{Fórmula de Specificity para Isolation Forest}

            \begin{align}
                  F1_{score} = 2 \cdot \frac{Precision * Recall}{Precision+Recall} \notag \\
                  \label{eq:f1_if}
            \end{align}
            \myequations{Fórmula de F1 Score para Isolation Forest}
