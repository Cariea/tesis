...
En función del analisis realizado, se procedio a definir los requerimientos del sistema de monitoreo acústico para la detección de emergencias en el hogar. Mismos requerimientos en los que se basará la verificación del sistema en etapas posteriores. Veanse en la tabla \ref{tab:requerimientos_sistema_acustico}
