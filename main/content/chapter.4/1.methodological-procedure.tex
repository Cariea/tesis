...
\begin{enumerate}
      \item Preparación de los Datos:
            ...
            De manera similar, el modelo puede procesar etiquetas de texto como ``uso de microondas'' o ``sensor de movimiento''. Pero le facilitaria el aprendizaje si estas etiquetas se convierten en números. Un error común sería asignarles un número a cada una (ej: microondas=1, sensor=2), ya que esto crearía una falsa relación matemática (como si el ``sensor'' fuera el doble del ``microondas'').
