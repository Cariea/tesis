...
El sistema final implementado se configura como una solución de Edge Computing autónoma que opera en el dispositivo Raspberry Pi. El flujo de trabajo comienza con la captación de audio a través de micrófonos conectados, garantizando la adquisición continua de la señal acústica. Estos datos brutos son inmediatamente procesados por la capa de clasificación, que utiliza agentes como YAMNet y Vosk para seleccionar y transformar el audio en eventos categóricos y representaciones semánticas (datos característicos). Esta información estructurada alimenta el LSTM autoencoder V2, el modelo central de la capa de detección de anomalías, el cual ha sido optimizado bayesianamente para calcular el error de reconstrucción en tiempo real. Finalmente, si el error excede el umbral redefinido, la capa de gestión de alertas valida la situación, y la capa de notificaciones genera el resultado obtenido mediante un mensaje de emergencia a través de Telegram o SMTP. De este modo, el sistema ofrece un mecanismo de monitoreo acústico autonomo, capaz de detectar y notificar eventos anómalos en tiempo real, todo dentro del entorno local del dispositivo edge.
