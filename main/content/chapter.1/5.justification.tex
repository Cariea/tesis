...
% En este contexto, el presente proyecto propone un sistema de monitoreo acústico basado en inteligencia artificial, diseñado para identificar sonidos inusuales que puedan estar asociados a eventos de emergencia. Al generar alertas automáticas en tiempo real, el sistema facilita la intervención oportuna de familiares, cuidadores o servicios de asistencia ante incidentes potenciales.
